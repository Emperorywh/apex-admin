					...
					>
						...
						<div className="grid grid-cols-2 gap-4 mb-6">
							<Button
								icon={<MobileOutlined />}
								block
								className="dark:bg-transparent dark:text-gray-300 dark:border-gray-600"
							>
								{t('手机登录')}
							</Button>
							<Button
			...
			<div className="hidden lg:flex flex-1 relative bg-gray-50 dark:bg-gray-950 items-center justify-center overflow-hidden">
				...
				<div className="relative z-10 flex flex-col items-center justify-center p-12 text-center">
					<div className="w-[400px] h-[400px] bg-white dark:bg-gray-800 rounded-full shadow-2xl flex items-center justify-center mb-8 relative overflow-hidden group">
						...
						{/* Orbit Circles */}
						<div
							className="absolute w-[120%] h-[120%] border border-dashed border-gray-200 dark:border-gray-700 rounded-full animate-spin-slow"
							style={{ animationDuration: '20s' }}
						></div>
						<div
							className="absolute w-[80%] h-[80%] border border-dashed border-gray-200 dark:border-gray-700 rounded-full animate-reverse-spin"
					...
					<p className="text-gray-500 dark:text-gray-400 max-w-md text-lg">
						{t(
							'开箱即用的中后台管理系统，提供丰富的组件和模板，帮助您快速搭建现代化应用。',
						)}
					</p>
				</div>
			</div>
