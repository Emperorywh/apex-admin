...
const KeepAliveTabs: React.FC<KeepAliveTabsProps> = (props) => {
    ...
    const { items = [], activeKey, onRemove, onChange, setItems, onRefresh, onCloseOthers, onCloseAll } = props;
    ...
    return <Tabs
        ...
        renderTabBar={(tabBarProps, DefaultTabBar) => (
            <DndContext sensors={[sensor]} onDragEnd={onDragEnd} collisionDetection={closestCenter} modifiers={[restrictToHorizontalAxis]}>
